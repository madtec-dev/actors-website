...
$(window).scroll(function(){$("#navigation").offset().top>50?$("#navigation").addClass("top-nav-collapse"):$("#navigation").removeClass("top-nav-collapse")}),$(".spin-icon").click(function(){$(".theme-config-box").toggleClass("show")}),$(document).ready(function(){$.get("views/skin-config.html",function(n){$("body").append(n)})});