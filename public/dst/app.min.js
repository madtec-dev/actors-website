...
$(window).scroll(function(){$("#navigation").offset().top>50?$("#navigation").addClass("top-nav-collapse"):$("#navigation").removeClass("top-nav-collapse")}),$(".spin-icon").click(function(){$(".theme-config-box").toggleClass("show")}),$(document).ready(function(){function n(){$("body").swipe({swipe:function(n,e,o,i,a,t){console.log(e);var l=$.magnificPopup.instance;"left"===e&&l.next(),"right"===e&&l.prev()}})}$.get("views/skin-config.html",function(n){$("body").append(n)}),$(".gallery").magnificPopup({delegate:"a",gallery:{enabled:!0},type:"image",callbacks:{beforeOpen:function(){n(),$("body").swipe("enable")},afterClose:function(){$("body").swipe("disable")}}})});